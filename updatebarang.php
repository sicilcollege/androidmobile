...
$db = mysqli_connect($mysql_hostname, $mysql_user, $mysql_password,$mysql_database) or die("Opps some thing went wrong");
    ...
    if(isset($_SERVER['REQUEST_METHOD'])){
        ...
        $get_result = mysqli_query($db,"UPDATE sclbarang SET nama_barang='$nama_barang', satuan_barang='$satuan_barang', stok_barang='$stok_barang', harga_beli_barang='$harga_beli_barang', harga_jual_barang='$harga_jual_barang' WHERE id_barang='$id_barang'"); 
