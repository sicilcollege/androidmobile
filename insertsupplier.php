...
$db = mysqli_connect($mysql_hostname, $mysql_user, $mysql_password,$mysql_database) or die("Opps some thing went wrong");
    ...
    if(isset($_SERVER['REQUEST_METHOD'])){
        ...
        $get_result = mysqli_query($db,"INSERT INTO sclsupplier(id_supplier,nama_supplier,telp_supplier,alamat_supplier) VALUES ('$id_supplier','$nama_supplier','$telp_supplier','$alamat_supplier')"); 
