...
$db = mysqli_connect($mysql_hostname, $mysql_user, $mysql_password,$mysql_database) or die("Opps some thing went wrong");
    ...
    if(isset($_SERVER['REQUEST_METHOD'])){
        ...
        $get_result = mysqli_query($db,"INSERT INTO sclkaryawan(id_karyawan,nama_karyawan,telp_karyawan,alamat_karyawan,password_karyawan) VALUES ('$id_karyawan','$nama_karyawan','$telp_karyawan','$alamat_karyawan','$password_karyawan')"); 
